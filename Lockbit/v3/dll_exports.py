...
INTERESTING_DLLS = [
    'gpedit.dll', 'kernel32.dll', 'comctl32.dll', 'advapi32.dll', 'comdlg32.dll',
    ...
    'winhttp.dll',  'wininet.dll',  'wsock32.dll',   'wship6.dll',
    'advpack.dll',
    'wow64cpu.dll',
    'KERNELBASE.dll',
    'ucrtbase.dll',
...
# "kernel32.dll:InterlockedIncrement", "ntdll.dll:_alldiv"
...
exports_list.append("kernel32.dll:InterlockedIncrement")
exports_list.append("ntdll.dll:_alldiv")
